...
set.seed(43)
y <- rnorm(1000, 100, 10)
hist(y, xlim=c(50,150), main="", probability=TRUE, col=17)
```
...
hist(y, xlim=c(50,150), main="", probability=TRUE, col=17)
lines(c(50:150),dnorm(c(50:150),80,10),col=2,lwd=2)
abline(v=80,col=2,lwd=2)
```
...
hist(y, xlim=c(50,150), main="", probability=TRUE, col=17)
lines(c(50:150),dnorm(c(50:150),90,10),col=7,lwd=2)
abline(v=90,col=7,lwd=2)
```
...
hist(y, xlim=c(50,150), main="", probability=TRUE, col=17)
lines(c(50:150),dnorm(c(50:150),100,10),col=4,lwd=2)
abline(v=100,col=4,lwd=2)
```
...
hist(y, xlim=c(50,150), main="", probability=TRUE, col=17)
lines(c(50:150),dnorm(c(50:150),mean(y),10),col=3,lwd=2)
...
hist(y, xlim=c(50,150), main="", probability=TRUE, col=17)
lines(c(50:150),dnorm(c(50:150),mean(y),15),col=6,lwd=2)
abline(v=mean(y),col=6,lwd=2)
```
...
hist(y, main="", probability=T, xlim=c(0,300), col=17)
lines(c(0:300),dnorm(c(0:300),mean(y),sd(y)),col=2,lwd=2)
```
...
hist(y, main="", probability=T, xlim=c(0,300), col=17)
lines(c(0:300),dlnorm(c(0:300),mean(log(y)),sd(log(y))),col=3,lwd=2)
```
...
lines(c(0,-3),c(0,2), col=14, lty=2)
lines(c(0,-6),c(0,-6), col=14, lty=2)
lines(c(0,3),c(0,5), col=14, lty=2)
lines(c(0,6),c(0,-1), col=14, lty=2)
