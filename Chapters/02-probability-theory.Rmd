...
The theorem's origins trace back to the work of the Reverend Thomas Bayes, whose work "An Essay Toward Solving a Problem in the Doctrine of Chances" was published posthumously in 1764. The derivation begins with the multiplication law for two events, A and B, which states that the probability of both events occurring together can be expressed in two ways (as we saw in equation \@ref(ProbmultiplicationLawJoint)):
\begin{equation*}
    P(A \cap B) = P(B) \times P(A|B) = P(A) \times P(B|A) .
\end{equation*}
