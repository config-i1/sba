...
```{r treeForSpam01, fig.height=7, echo=FALSE, fig.cap="Tree diagram for the spam detection example."}
# Set up blank plot
plot(1, type="n", xlim=c(0,10), ylim=c(1,10), axes=FALSE, xlab="", ylab="")
...
```{r treeForSpam02, fig.height=7, echo=FALSE, fig.cap="Tree diagram for the spam detection example, starting from the word \"discount\"."}
# Set up blank plot
plot(1, type="n", xlim=c(0,10), ylim=c(1,10), axes=FALSE, xlab="", ylab="")
