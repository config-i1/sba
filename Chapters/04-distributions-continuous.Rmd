...
\begin{equation}
    ...
    (\#eq:LogNormalPDF)
\end{equation}
The skewness of distribution depends on the value of $\sigma^2$ - the higher it is, the more skewed the distribution is. In fact, the skewness can be calculated as:
\begin{equation}
