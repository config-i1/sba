...
\begin{equation}
    \Phi(y_2, \mu, \sigma^2) - \Phi(y_1, \mu, \sigma^2) = \Phi(1, 0, 1) - \Phi(-1, 0, 1) \approx 0.683.
    (\#eq:NormalCDFExample)
\end{equation}
The CDF itself is difficult to summarise and involves a complicated integral, which does not have a closed form:
\begin{equation}
    \Phi(y, \mu, \sigma^2) = \frac{1}{\sqrt{2 \pi}} \int_{-\infty}^{y} e^{-\frac{t^2}{2}} dt .
    (\#eq:NormalCDFE)
\end{equation}
