...
```{r uniformPMFCombined, fig.cap="Probability Mass Function of the sum of two Uniform distributions for 1d6.", echo=FALSE}
apply(expand.grid(1:6,1:6), 1, sum) |> table() -> z
test <- barplot(z/sum(z),
                ylim=c(0,0.22), ylab="Probability", xlab="z", 
