...
```{r uniformPMFSlide01, fig.cap="Convolution of two PMFs for 1d6.", fig.height=3, fig.width=8, echo=FALSE}
x <- c(1:6)
...
```{r uniformPMFSlide02, fig.cap="Convolution of two PMFs for 1d6.", fig.height=3, fig.width=8, echo=FALSE}
x <- c(1:6)
y <- table(12-x+1)
...
```{r uniformPMFSlide03, fig.cap="Convolution of two PMFs for 1d6.", fig.height=3, fig.width=8, echo=FALSE}
x <- c(1:6)
