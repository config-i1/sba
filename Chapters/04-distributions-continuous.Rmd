...
axis(side=1,at=test,labels=c(1:6), col.axis=5)
```
...
test2 <- barplot(y/6,
                 ...
                 add=T)
abline(h=0, lwd=2)
text(test1, 1/6, labels=c(6:1), pos=3, col=3)
text(test2[-c(1:4)], 0, labels=c(1:6), pos=1, col=5)
...
text(test3, 0, labels=c(2:12)[1:2], pos=1, col=5)
abline(h=0, lwd=2)
```
...
abline(h=0, lwd=2)
text(test1, 1/6, labels=c(6:1), pos=3, col=3)
text(test2, 0, labels=c(1:6), pos=1, col=5)
...
abline(h=0, lwd=2)
text(test3, 0, labels=c(2:12)[1:6], pos=1, col=5)
```
...
test1 <- barplot(table(x)/6,
                 ...
                 add=T)
abline(h=0, lwd=2)
text(test2[-c(1:2)], 1/6, labels=c(6:1), pos=3, col=3)
text(test1, 0, labels=c(1:6), pos=1, col=5)
text(test1[c(3:6)], 1/12, labels=rep(9,4), col=2)
...
abline(h=0, lwd=2)
text(test3, 0, labels=c(2:12)[1:8], pos=1, col=5)
```
...
test <- barplot(z/sum(z),
                ylim=c(0,0.23), ylab="Probability", xlab="z", 
                col=10, axes=F, names.arg="")
