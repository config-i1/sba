...
```{r normalLogConnection, fig.cap="Connection between Normal and Log-Normal distributions"}
...
lines(rep(0.5,2), c(0,dnorm(0.5,0,0.5)), lty=2, lwd=2, col="grey")
...
# lines(c(0,dlnorm(exp(0.5),0,0.5)), rep(exp(0.5),2), lty=2, lwd=2, col="grey")
abline(h=exp(0.5), lty=2, lwd=2, col="grey")
# polygon()
plot(seq(-1.5,1.5,0.01), exp(seq(-1.5,1.5,0.01)), type="l", xlab="x", ylab="y")
lines(rep(0.5,2), c(5,exp(0.5)), lty=2, lwd=2, col="grey")
# abline(v=0.5, lty=2, lwd=2, col="grey")
lines(c(-2,0.5), rep(exp(0.5),2), lty=2, lwd=2, col="grey")
```
