...
\begin{equation}
    ...
    (\#eq:NormalCDFE)
\end{equation}
where $\mathrm{erf(x)= \frac{2}{\sqrt{\pi}} \int_{0}^{y} e^{-t^2} dt}$ is the so called ``error function''. This function does not have a closed form and is typically evaluated numerically or using some approximations.
