...
```{r predictionInterval, fig.cap="Prediction interval", echo=FALSE}
y <- rnorm(100,100,10)
...
When conducting a conventional statistical test, we can have one of the four situations, depending on what happens in real life and what results we have obtained:

```{r typeErrorsTable, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
typeErrorsTable <- "
|                                        |                 Reality                   |
|                                        |     H0 is true     |      H0 is wrong     |
|----------------------------------------|--------------------|----------------------|
| The data tells us | Fail to reject H0  | Correct decision,  | Type II error,       |
|                   |                    | Probability is 1-α | Probability is β     |
|----------------------------------------|--------------------|----------------------|
|                   | Reject H0          | Type I error,      | Correct decision,    |
|                   |                    | Probability is α   | Probability is 1 − β |
|----------------------------------------|--------------------|----------------------|
"
cat(typeErrorsTable)
```

Note that H0 is always wrong...

Type 0 error

### Power of the test {#powerOfTheTest}
