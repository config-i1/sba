...
abline(h=0, col=14, lty=2)
abline(v=0, col=14, lty=2)
abline(slmSpeedDistance, col=2)
```
...
abline(slmSpeedDistanceModel01, col=2)
```
...
lines(cars$speed,exp(fitted(slmSpeedDistanceModel01)),col=2)
```
...
lines(c(-10:30)^2,coef(slmSpeedDistanceModel02)[1]+coef(slmSpeedDistanceModel02)[2]*c(-10:30)^2,col=2)
```
...
lines(c(-10:30), coef(slmSpeedDistanceModel02)[1] +
        coef(slmSpeedDistanceModel02)[2]*c(-10:30)^2, col=2)
lines(c(-10:30), coef(slmSpeedDistanceModel03)[1]*c(-10:30)^2, col=4)
legend("topleft",legend=c("Model 2","Model 3"), lwd=1, col=c(2,4))
```
...
abline(slmSpeedDistanceModel04, col=2)
```
...
lines(c(-10:30), predict(slmSpeedDistanceModel04,
                         newdata=data.frame(speed=c(-10:30)))$mean^2, col=2)
lines(c(-10:30), predict(slmSpeedDistanceModel05,
                         newdata=data.frame(speed=c(-10:30)))$mean^2, col=4)
legend("topleft",legend=c("Model 4","Model 5"), lwd=1, col=c(2,4))
```
...
lines(1.5*exp(0.05*c(1:100)), col=2)
plot(c(1:100), 1.5*exp(-0.05*c(1:100)) * rlnorm(100,0,0.1),
     xlab="x", ylab="y", main=TeX("$\\beta_1=-0.05$"))
lines(1.5*exp(-0.05*c(1:100)), col=2)
```
...
plot(c(1:100), 5+1.5*sqrt(c(1:100)) +rnorm(100,0,0.5),
     xlab="x", ylab="y", main=TeX("$\\beta_1=1.5$"))
lines(5 +1.5*sqrt(c(1:100)), col=2)
plot(c(1:100), 5-1.5*sqrt(c(1:100)) +rnorm(100,0,0.5),
     xlab="x", ylab="y", main=TeX("$\\beta_1=-1.5$"))
lines(5 -1.5*sqrt(c(1:100)), col=2)
```
...
lines(400-20*c(1:100)+0.2*c(1:100)^2, col=2)
plot(c(1:100), 400+20*c(1:100)-0.2*c(1:100)^2 +rnorm(100,0,10),
     xlab="x", ylab="y", main=TeX("$\\beta_1=20$, $\\beta_2=-0.2$"))
lines(400+20*c(1:100)+-.2*c(1:100)^2, col=2)
```
...
plot(1/(1+exp(8-0.03*c(1:500) +rnorm(100,0,1))),
     xlab="x", ylab="y", main="")
lines(1/(1+exp(8-0.03*c(1:500))), col=2)
```
