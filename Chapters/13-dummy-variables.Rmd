...
We see that the type of this building was "detached". So when we create the dummy variable "type_detached", we would encode it being equal to one for this and all the other observations that have this type, and to zero otherwise.
