...
polygon(c(seq(-5,5,0.1),rev(seq(-5,5,0.1))),
        c(dt(seq(-5,5,0.1), 36-1),rep(0,length(seq(-5,5,0.1)))), col=17, lty=0)
lines(seq(-5,5,0.1), dt(seq(-5,5,0.1), 36-1), lwd=2, lty=1, col=2)
lines(c(-5,5), c(0,0), col=1, lwd=1)
polygon(c(seq(-5,qt(0.025, 36-1),0.01),rev(seq(-5,qt(0.025, 36-1),0.01))),
        c(dt(seq(-5,qt(0.025, 36-1),0.01),36-1), rep(0,length(seq(-5,qt(0.025, 36-1),0.01)))), col=15)
polygon(c(seq(qt(0.975, 36-1),5,0.01),rev(seq(qt(0.975, 36-1),5,0.01))),
        c(dt(seq(qt(0.975, 36-1),5,0.01),36-1), rep(0,length(seq(qt(0.975, 36-1),5,0.01)))), col=15)
abline(v=qt(c(0.025,0.975),36-1), col=4, lwd=2)
abline(v=-3, col=2, lwd=2, lty=2)
legend("topright",legend=c("critical values","calculated t",TeX("$1-\\alpha$"),TeX("$\\alpha$")),
       lwd=c(2,2,6,6), col=c(4,2,17,15), lty=c(1,2,1,1))
```
...
polygon(c(seq(-1.5,0.5,0.01),rev(seq(-1.5,0.5,0.01))),
        c(dt((seq(-1.5,0.5,0.01)+0.5)*6, 36-1),rep(0,length(seq(-1.5,0.5,0.01)))), col=17, lty=0)
lines(seq(-1.5,0.5,0.01), dt((seq(-1.5,0.5,0.01)+0.5)*6, 36-1), lwd=2, lty=1, col=2)
lines(c(-1.5,0.5), c(0,0), col=1, lwd=1)
polygon(c(seq(-1.5,qt(0.025, 36-1)/6-0.5,0.01),rev(seq(-1.5,qt(0.025, 36-1)/6-0.5,0.01))),
        c(dt((seq(-1.5,qt(0.025, 36-1)/6-0.5,0.01)+0.5)*6,36-1), rep(0,length(seq(-1.5,qt(0.025, 36-1)/6-0.5,0.01)))), col=15)
polygon(c(seq(qt(0.975, 36-1)/6-0.5,0.5,0.01),rev(seq(qt(0.975, 36-1)/6-0.5,0.5,0.01))),
        c(dt((seq(qt(0.975, 36-1)/6-0.5,0.5,0.01)+0.5)*6,36-1), rep(0,length(seq(qt(0.975, 36-1)/6-0.5,0.5,0.01)))), col=15)
abline(v=qt(c(0.025,0.975),36-1)/6-0.5, col=4, lwd=2)
...
```{r}
pt(3, 36-1, lower.tail=FALSE)
```
::: remark
We use absolute value of statistics in the formula above and calculate the p-value based on the right tail of distribution. This is the conventional way of doing that, although we would have gotten the same result with the command `pt(-3, 36-1, lower.tail=TRUE)`.
:::
...
plot(seq(-8,10,0.1), dnorm(seq(-8,10,0.1)), xlab="z", ylab="Density", type="l",
     lwd=0, lty=0, col=4, xlim=c(-7,4))
polygon(c(seq(-8,10,0.1),rev(seq(-8,10,0.1))),
        c(dnorm(seq(-8,10,0.1)),rep(0,length(seq(-8,10,0.1)))), col=17, lty=0)
lines(seq(-8,10,0.1), dnorm(seq(-8,10,0.1)), lwd=2, lty=1, col=2)
lines(c(-8,10), c(0,0), col=1, lwd=1)
polygon(c(seq(-8,qnorm(0.05),0.01),rev(seq(-8,qnorm(0.05),0.01))),
        c(dnorm(seq(-8,qnorm(0.05),0.01)), rep(0,length(seq(-8,qnorm(0.05),0.01)))), col=15)
abline(v=qnorm(0.05), col=4, lwd=2)
abline(v=-2.66, col=2, lwd=2, lty=2)
...
polygon(c(seq(-8,qnorm(0.05),0.01),rev(seq(-8,qnorm(0.05),0.01))),
        c(dnorm(seq(-8,qnorm(0.05),0.01)), rep(0,length(seq(-8,qnorm(0.05),0.01)))), col=15)
lines(seq(-8,10,0.1), dnorm(seq(-8,10,0.1),-4), lwd=2, lty=2, col=3)
abline(v=qnorm(0.05), col=4, lwd=2)
abline(v=-2.66, col=2, lwd=2, lty=2)
abline(v=-4, col=3, lwd=2, lty=2)
legend("topright",legend=c("critical values","calculated z","True distribution",TeX("$1-\\alpha$"),TeX("$\\alpha$")),
       lwd=c(2,2,2,6,6), col=c(4,2,3,17,15), lty=c(1,2,2,1,1))
```
...
lines(seq(-8,10,0.1), dnorm(seq(-8,10,0.1)), lwd=2, lty=1, col=2)
lines(c(-8,10), c(0,0), col=1, lwd=1)
lines(seq(-8,10,0.1), dnorm(seq(-8,10,0.1),-2.5), lwd=2, lty=2, col=3)
polygon(c(seq(-8,qnorm(0.05),0.01),rev(seq(-8,qnorm(0.05),0.01))),
...
legend("topright",legend=c("critical values","True distribution","Power of the Test"),
       lwd=c(2,2,6), col=c(4,3,9), lty=c(1,2,1))
```
...
lines(muValuesNew, pnorm((zValue - muValuesNew)/(yMeanSD*6/sqrt(300))), col=2)
lines(muValuesNew, pnorm((zValue - muValuesNew)/(yMeanSD*6/sqrt(100))), col=3)
lines(muValuesNew, pnorm((zValue - muValuesNew)/(yMeanSD*6/sqrt(50))), col=4)
lines(muValuesNew, pnorm((zValue - muValuesNew)/(yMeanSD*6/sqrt(25))), col=5)
...
significanceTable <- data.frame(C1 = c("Practically significant","Practically insignificant"),
                                C2 = c("Make a decision","Think about whether the decision should be changed"),
                                C3 = c("Collect more evidence to make a correct decision","Do not make a decision"))
...
In Table \@ref(tab:significanceTable), there are two situations, when there is nothing to argue about: when practical and statistical significances agree with each other (either they are both significant or not). However, I argue that the practical significance is in general more important than the statistical one. If you find that a new decision will reduce costs but the reduction will not be statistically significant, then it makes sense to collect more evidence to make sure that the decision is correct. On the other hand, if the decision is statistically significant (for instance, it improves the process by 1%, being significant on the selected level), but it is not practically significant (the costs of implementing it are higher than the savings from it) then it makes sense to think whether the decisions should be changed and whether it should be made at all. This is because the statistical outcomes are always associated with potential Type I and Type II errors discussed in Section \@ref(typeErrors) and thus not finding difference could be due to Type II error, while finding one could be due to Type I error. When it comes to making decisions, the results of statistical testing should only help in supporting them, rather than guiding them.
