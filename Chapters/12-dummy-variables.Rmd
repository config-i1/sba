...
\begin{equation}
    sales_t = \beta_0 + \beta_1 price_t + \beta_2 colourRed_t + \beta_3 colourGreen_t + \epsilon_t .
...
\begin{equation}
    sales_t = \beta_0 + \beta_1 price_t + \beta_2 price_t \times colourRed_t + \beta_3 price_t \times colourGreen_t + \epsilon_t .
...
1. Red colour: $sales_t = \beta_0 + \beta_1 price_t + \beta_2 price_t + \epsilon_t$ or $sales_t = \beta_0 + (\beta_1 + \beta_2) price_t + \epsilon_t$;
2. Green colour: $sales_t = \beta_0 + \beta_1 price_t + \beta_3 price_t + \epsilon_t$ or $sales_t = \beta_0 + (\beta_1 + \beta_3) price_t + \epsilon_t$;
3. Blue colour: $sales_t = \beta_0 + \beta_1 price_t + \epsilon_t$.
