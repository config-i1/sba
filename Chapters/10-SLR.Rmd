...
abline(slmTrees, col=2, lwd=2, lty=2)
...
plot(0, 0, col=0,
     ...
     xlab="x", ylab="y")
abline(h=0, col=14, lwd=2, lty=2)
abline(v=0, col=14, lwd=2, lty=2)
points(x,y, col=10)
abline(a=b0, b=b1, col=2, lwd=2, lty=2)
draw.arc(-2.5,0,10,0,atan(b1), lwd=2, col=2)
text(8, 5, TeX("$\\phi=\\arctan (\\beta_1)$"), pos=4, col=2)
arrows(-7, b0, -0.1, b0, col=2, lty=1, lwd=2, angle=10)
text(-8, b0, TeX("$\\beta_0$"), pos=NULL, col=2)
```
...
abline(v=mean(SBA_Chapter_10_Trees$height), lty=5, col=4, lwd=2)
abline(a=a, b=b, col=2, lwd=2, lty=2)

points(x1, y1, col=2, pch=4, lwd=2)
points(x2, y2, col=2, pch=4, lwd=2)
lines(c(x1,x1), c(0,y1), lty=3, col=14, lwd=2)
lines(c(0,x1), c(y1,y1), lty=3, col=14, lwd=2)
lines(c(x2,x2), c(0,y2), lty=3, col=14, lwd=2)
lines(c(0,x2), c(y2,y2), lty=3, col=14, lwd=2)
```
...
points(x,y, col=10)
abline(a=b0, b=b1, col=2, lwd=2, lty=2)
draw.arc(0,0,8,0,atan(b1), lwd=2, col=2)
...
points(x,y, col=10)
abline(a=b0, b=b1, col=2, lwd=2, lty=2)
draw.arc(1,0,7,0,atan(b1), lwd=2, col=2)
text(8, 5, TeX("$\\arctan (b_1)$"), pos=4, col=2)
abline(a=0, b=1/a1, col=4, lwd=2, lty=2)
draw.arc(0,0,8,atan(1/a1),pi/2, lwd=2, col=4)
text(6, 12, TeX("$\\arctan (a_1)$"), pos=2, col=4)

y <- -y
b1 <- cov(x,y) / var(x)
a1 <- cov(x,y) / var(y)
plot(x-mean(x),y-mean(y), col=10,
     xlim=c(-30,30), ylim=c(-30,30),
     xlab="x", ylab="y", main="Negative correlation")
abline(h=0, col=14, lwd=2, lty=2)
abline(v=0, col=14, lwd=2, lty=2)
abline(a=0, b=b1, col=2, lwd=2, lty=2)
draw.arc(1,0,7,0,atan(b1), lwd=2, col=2)
text(8, -5, TeX("$\\arctan (b_1)$"), pos=4, col=2)
abline(a=0, b=1/a1, col=4, lwd=2, lty=2)
draw.arc(0,0,8,atan(1/a1)+pi,pi/2, lwd=2, col=4)
text(9, 14, TeX("$\\arctan (a_1)$"), pos=2, col=4)

plot(x-mean(x),x-mean(x), col=10,
     xlim=c(-30,30), ylim=c(-30,30),
     xlab="x", ylab="y", main="Perfect correlation")
abline(h=0, col=14, lwd=2, lty=2)
abline(v=0, col=14, lwd=2, lty=2)
abline(a=0, b=1, col=2, lwd=2, lty=2)
draw.arc(0,0,8,0,pi/4, lwd=2, col=2)
text(8, 5, TeX("$\\arctan (b_1)$"), pos=4, col=2)
abline(a=0, b=1, col=4, lwd=2, lty=2)
draw.arc(0,0,8,pi/4,pi/2, lwd=2, col=4)
text(6, 12, TeX("$\\arctan (a_1)$"), pos=2, col=4)

plot(x-mean(x),rnorm(1000,0,10), col=10,
     xlim=c(-30,30), ylim=c(-30,30),
     xlab="x", ylab="y", main="Zero correlation")
abline(h=0, col=14, lwd=2, lty=2)
abline(v=0, col=14, lwd=2, lty=2)
abline(a=0, b=0, col=2, lwd=2, lty=2)
abline(v=0, col=4, lwd=2, lty=2)
y <- -y
```
...
abline(a=b0, b=b1, col=2, lwd=2, lty=2)
polygon(c(0,sd(x),sd(x),0), c(0,0,rep(b1*sd(x),2)),
        density=10, lwd=2, col=4)
polygon(c(0,sd(x),sd(x),0), c(0,0,rep(sd(y),2)),
        density=10, lwd=2, col=2, angle=-45)
text(10, b1*sd(x)/2, TeX("$b_1 \\hat{\\sigma}_x$"), pos=4, col=4)
text(sd(x)/2, 0, TeX("$\\hat{\\sigma}_x$"), pos=1, col=4)
text(0, sd(y)/2, TeX("$\\hat{\\sigma}_y$"), pos=2, col=2)
text(sd(x)/2, 20, TeX("$\\hat{\\sigma}_x$"), pos=3, col=2)
```
...
text(sd(x)/2, 0, TeX("$\\hat{\\sigma}_x$"), pos=1, col=4)
text(0, sd(y)/2, TeX("$\\hat{\\sigma}_y$"), pos=2, col=2)
text(sd(x)/2, sd(y), TeX("$\\hat{\\sigma}_x$"), pos=3, col=2)
...
### Sums of squares {#linearRegressionSimpleQualityOfFitSSE}
...
R2
```
Note that in this formula we used the relation between SST and V$(y)$, multiplying the value by $n-1$ to get rid of the denominator. The resulting value tells us that the model has explained `r round(1 - sum(resid(slmTrees)^2) / (var(actuals(slmTrees))*(n-1)), digits)*100`% deviations in the data.
...
Coming back to the example that motivated this chapter, there is a way we can improve the model for the company and help them in making better decisions. After all, the determination coefficient of the model of volume from height was just `r round(R2, digits)`.
...
plot(SBA_Chapter_10_Trees$diameter, SBA_Chapter_10_Trees$volume,
     ...
     ylim=c(0,max(SBA_Chapter_10_Trees$volume)))
abline(slmTreesDiam, col=2, lwd=2, lty=2)
```
