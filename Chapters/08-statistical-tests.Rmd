...
polygon(c(seq(-5,5,0.1),rev(seq(-5,5,0.1))),
        c(dnorm(seq(-5,5,0.1)),rep(0,length(seq(-5,5,0.1)))), col=17, lty=0)
...
polygon(c(seq(-5,qnorm(1-pnorm(abs(1.6))),0.01),rev(seq(-5,qnorm(1-pnorm(abs(1.6))),0.01))),
        c(dnorm(seq(-5,qnorm(1-pnorm(abs(1.6))),0.01)), rep(0,length(seq(-5,qnorm(1-pnorm(abs(1.6))),0.01)))), col=15)
polygon(c(seq(qnorm(pnorm(abs(1.6))),5,0.01),rev(seq(qnorm(pnorm(abs(1.6))),5,0.01))),
        c(dnorm(seq(qnorm(pnorm(abs(1.6))),5,0.01)), rep(0,length(seq(qnorm(pnorm(abs(1.6))),5,0.01)))), col=15)
# abline(v=qnorm(c(1-pnorm(abs(1.6)),pnorm(abs(1.6)))), col=2, lwd=2)
abline(v=c(-1.6,1.6), col=2, lwd=2, lty=2)
text(-1.65,0.02,"-1.6",pos=2)
text(1.65,0.02,"1.6",pos=2)
legend("topright",legend=c("calculated z","p-value"),
       lwd=c(2,6), col=c(2,15), lty=c(2,1))
```
...
polygon(c(seq(0,100,0.1),rev(seq(0,100,0.1))),
        c(dchisq(seq(0,100,0.1),29),rep(0,length(seq(0,100,0.1)))), col=17, lty=0)
lines(seq(0,100,0.1), dchisq(seq(0,100,0.1),29), lwd=2, lty=1, col=2)
lines(c(0,100), c(0,0), col=1, lwd=1)
polygon(c(seq(0,qchisq(0.01,29),0.01),rev(seq(0,qchisq(0.01,29),0.01))),
        c(dchisq(seq(0,qchisq(0.01,29),0.01),29), rep(0,length(seq(0,qchisq(0.01,29),0.01)))), col=15)
abline(v=qchisq(0.01,29), col=4, lwd=2)
text(14.2,0.006,"14.26",pos=4)
abline(v=23.97, col=2, lwd=2, lty=2)
text(24,0.004,"23.97",pos=4)
legend("topright",legend=c(TeX("critical $\\chi^2$$"),TeX("calculated $\\chi^2$$"),TeX("$\\alpha =0.01$")),
       lwd=c(2,2,6), col=c(4,2,15), lty=c(1,2,1))
```
...
polygon(c(seq(0,qchisq(0.025,29),0.01),rev(seq(0,qchisq(0.025,29),0.01))),
        c(dchisq(seq(0,qchisq(0.025,29),0.01),29), rep(0,length(seq(0,qchisq(0.025,29),0.01)))), col=15)
abline(v=qchisq(0.025,29), col=4, lwd=2)
polygon(c(seq(100,qchisq(0.975,29),-0.01),rev(seq(100,qchisq(0.975,29),-0.01))),
        c(dchisq(seq(100,qchisq(0.975,29),-0.01),29), rep(0,length(seq(100,qchisq(0.975,29),-0.01)))), col=16)
abline(v=qchisq(0.975,29), col=4, lwd=2)
legend("topright",legend=c("critical values","95%","left 2.5%", "right 2.5%"),
       lwd=c(2,6,6,6), col=c(4,17,15,16))
```
