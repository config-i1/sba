...
1. There are many trials (in our example with the hospital, many people leave in the area).
...
These three criteria can be used to indentify Poisson distribution in practice.
:::
